...
6. Keep `RCS-0033` in backlog and execute it after current admin-slice priority queue.
...
9. Keep `todo/agent-memory/` files and `todo/board/` card states updated at the end of each loop.
